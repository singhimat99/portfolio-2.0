...
export default function About({}: Props) {
    return (
        <div className="relative flex flex-col md:flex-row justify-center items-center h-full gap-10 m-8">
            ...
            <div className="flex flex-col justify-center ">
                ...
                <p className="text-center md:m-8">
                    ...
                    Iusto inventore dicta illo tempore mollitia dolores dolorum
                    dolor ex totam eveniet ut, ipsam maxime neque, ducimus
                    molestiae blanditiis odio laborum eaque!
                </p>
            </div>
        </div>
    );
